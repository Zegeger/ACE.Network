...
namespace ACE.Network.Messages
{
    ...
    /// </summary>
    public class AllegianceChatBootC2S : OrderedMessage
    {
        /// <summary>
        ...
        public AllegianceChatBootC2S() : base((MessageType)0x02A0, MessageDirection.ClientToServer, (Queues)0x00000003)
        { }

        public AllegianceChatBootC2S(BinaryReader reader) : this()
        {
            Unpack(reader);
        }
