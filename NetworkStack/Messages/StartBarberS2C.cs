...
namespace ACE.Network.Messages
{
    ...
    /// Opens barber UI
    /// </summary>
    public class StartBarberS2C : OrderedMessage
    {
        [MessageProperty]
        ...
        public StartBarberS2C() : base((MessageType)0x0075, MessageDirection.ServerToClient, (Queues)0x00000009)
        { }

        public StartBarberS2C(BinaryReader reader) : this()
        {
            Unpack(reader);
        }
