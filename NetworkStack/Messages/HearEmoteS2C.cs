...
namespace ACE.Network.Messages
{
    ...
    /// Indirect '/e' text.
    /// </summary>
    public class HearEmoteS2C : Message
    {
        /// <summary>
        ...
        public HearEmoteS2C() : base((MessageType)0x01E0, MessageDirection.ServerToClient, (Queues)0x00000009)
        { }

        public HearEmoteS2C(BinaryReader reader) : this()
        {
            Unpack(reader);
        }
