...
namespace ACE.Network.Messages
{
    ...
    /// </summary>
    public class BookDeletePageResponseS2C : OrderedMessage
    {
        /// <summary>
        ...
        public BookDeletePageResponseS2C() : base((MessageType)0x00B7, MessageDirection.ServerToClient, (Queues)0x00000009)
        { }

        public BookDeletePageResponseS2C(BinaryReader reader) : this()
        {
            Unpack(reader);
        }
