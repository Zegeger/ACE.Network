...
namespace ACE.Network.Messages
{
    ...
    /// </summary>
    public class TurbineChatC2S : Message
    {
        /// <summary>
        ...
        public TurbineChatC2S() : base((MessageType)0xF7DE, MessageDirection.ClientToServer, (Queues)0x00000004)
        { }

        public TurbineChatC2S(BinaryReader reader) : this()
        {
            Unpack(reader);
        }
                ...
                case TurbineChatType.ClientToServerMessage:
                    switch(BlobDispatchType)
                    {
                        case 0x01:
                            ...
                            if(temp1 != 1)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 1, actual " + temp1);
                            }
#endif
                            ...
                            if(temp2 != 1)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 1, actual " + temp2);
                            }
#endif
                        ...
                        case 0x02:
                            ...
                            if(temp3 != 2)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 2, actual " + temp3);
                            }
#endif
                            ...
                            if(temp4 != 2)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 2, actual " + temp4);
                            }
#endif
                            RoomID = reader.ReadUInt32();
                            Text = reader.ReadWString();
                ...
                case TurbineChatType.AckClientToServerMessage:
                    switch(BlobDispatchType)
                    {
                        case 0x01:
                            ...
                            if(temp5 != 1)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 1, actual " + temp5);
                            }
#endif
                            ...
                            if(temp6 != 1)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 1, actual " + temp6);
                            }
#endif
                            HResult = reader.ReadInt32();
                        break;
                        case 0x02:
                            ...
                            if(temp7 != 2)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 2, actual " + temp7);
                            }
#endif
                            ...
                            if(temp8 != 2)
                            {
                                throw new Exception("Recieved value different from static on TurbineChatC2S, expected: 2, actual " + temp8);
                            }
#endif
                            HResult = reader.ReadInt32();
                        break;
