...
namespace ACE.Network.Types
{
    ...
    /// </summary>
    public class PublicWeenieDesc : IPackable
    {
        /// <summary>
        /// game data flags
        /// </summary>
        ...
        public void Unpack(BinaryReader reader)
        {
            ...
            WeenieClassID = reader.ReadUIntCompressed16();
            IconID = reader.ReadUIntCompressed16();
            Type = (ObjectType)reader.ReadUInt32();
            Bitfield = (ObjectDescriptionFlag)reader.ReadUInt32();
            reader.Align();
            if((Bitfield & ObjectDescriptionFlag.IncludesSecondHeader) != 0)
            {
            ...
            {
                IconOverlay = reader.ReadUIntCompressed16();
            }
            if((Header2 & 0x00000001) != 0)
            {
                IconUnderlay = reader.ReadUIntCompressed16();
            }
            if((Header & 0x80000000) != 0)
            {
                Material = (MaterialType)reader.ReadUInt32();
            }
            if((Header2 & 0x00000002) != 0)
            {
                CooldownID = reader.ReadUInt32();
            }
            if((Header2 & 0x00000004) != 0)
            {
                CooldownDuration = reader.ReadUInt64();
            }
            if((Header2 & 0x00000008) != 0)
            {
                PetOwner = reader.ReadUInt32();
            }
            reader.Align();
        ...
        public void Pack(BinaryWriter writer)
        {
            ...
            writer.WriteUIntCompressed16(WeenieClassID);
            writer.WriteUIntCompressed16(IconID);
            ...
            if((Header & 0x40000000) != 0)
            {
                writer.WriteUIntCompressed16(IconOverlay);
            }
            if((Header2 & 0x00000001) != 0)
            {
                writer.WriteUIntCompressed16(IconUnderlay);
            }
            if((Header & 0x80000000) != 0)
            {
